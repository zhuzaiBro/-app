    ...
    return (
        <View style={{ height: Dimensions.get("screen").height }}>
            ...
            <View style={{  alignItems: "center" }}>
                <Pressable style={{ position: "absolute", left: ROATE(16) }} onPress={() => {
                    navigation.goBack()
                    }}>
                    <Icon name='fanhuianniu-zuo'
                        style={{}} size={ROATE(24)} color="rgba(0,0,0,0.9)" />
                </Pressable>
                <Text style={{ fontSize: ROATE(16), fontWeight: "500",   marginTop: ROATE(6), textAlign: "center", color: "rgba(0,0,0,0.9)" }}>确认下单</Text>
            </View>
